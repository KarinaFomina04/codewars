...
// its multiples up to another value, limit . If limit is a multiple of integer, it should be included
// as well. There will only ever be positive integers passed into the function, not consisting of 0.
